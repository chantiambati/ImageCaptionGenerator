...
def main():
    ...
    st.write("Upload an image or capture one from your webcam. Optionally add text for conditional captioning.")

    uploaded_file = st.file_uploader("Choose an image...", type=["jpg", "jpeg", "png"])
    camera_image = st.camera_input("Or capture image using webcam")
